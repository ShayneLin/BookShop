...
<script type="text/javascript">
  ...
  <body>
<form id="form1" action="<c:url value='/orderAction_createOrder'/>" method="post">
	<input type="hidden" name="orderItemIds" value="${cartItemIds }"/>
	...
	<c:forEach items="${cartItemList }" var="cartItem">
		<tr align="center">
			<td align="right">
				<a class="linkImage" href="<c:url value='/bookAction_load?bid=${cartItem.book.bid}'/>"><img border="0" width="54" align="top" src="<c:url value='/${cartItem.book.image_b }'/>"/></a>
			</td>
			<td align="left">
				<a href="<c:url value='/bookAction_load?bid=${cartItem.book.bid}'/>"><span>${cartItem.book.bname }</span></a>
			</td>
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="北京市 昌平区 西三旗 金燕龙办公楼1层 "/>
		</td>
	</tr>
	<tr>
