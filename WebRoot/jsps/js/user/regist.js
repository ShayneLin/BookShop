...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url : "/bookshop/userAction_ajaxValidateLoginname",// 要请求的servlet
		data : {
			loginname : value
		},// 给服务器的参数
		type : "POST",
...
function validateEmail() {
	 ...
	 */
	$.ajax({
		url : "/bookshop/userAction_ajaxValidateEmail",// 要请求的servlet
		data : {
			email : value
		},// 给服务器的参数
		type : "POST",
...
function validateVerifyCode() {
	 ...
	 */
	$.ajax({
		url : "/bookshop/userAction_ajaxValidateVerifyCode",// 要请求的aciton
		data : {
			verifyCode : value
		},// 给服务器的参数
		type : "POST",
...
function _hyz() {
	...
	$("#imgVerifyCode").attr("src",
			"/bookshop/verifyCodeAction?a=" + new Date().getTime());
}
